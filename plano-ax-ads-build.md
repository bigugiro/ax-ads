...
**Próximo passo:** Sprint 7 — Motor PDCA: anomalias (cron + LLM), recomendações, regras/guardrails, otimização assistida sobre os dados do provider. **Integrações reais Meta/Google adiadas para os Sprints 11–13** (decisão de 2026-07-04): o SaaS inteiro é construído e vendável sobre dados simulados; as plataformas plugam na mesma interface no final.
