...
**Próximo passo:** Sprint 5 — CRM + automação: pipeline kanban, leads, automações (básica→avançada). **Integrações reais Meta/Google adiadas para os Sprints 11–13** (decisão de 2026-07-04): o SaaS inteiro é construído e vendável sobre dados simulados; as plataformas plugam na mesma interface no final.
