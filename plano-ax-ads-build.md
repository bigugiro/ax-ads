...
**Próximo passo:** Sprint 3 — Ações de campanha (pausar/ativar/ajustar budget via `AdsProvider` + `audit_log`). **Integrações reais Meta/Google adiadas para os Sprints 11–13** (decisão de 2026-07-04): o SaaS inteiro é construído e vendável sobre dados simulados; as plataformas plugam na mesma interface no final.
