...
**Próximo passo:** Sprint 2 — Dashboard mobile (`cron/sync-metricas` via provider, snapshots diários, painel ROAS/CAC/CPA/CTR por cliente e campanha). **Integrações reais Meta/Google adiadas para os Sprints 11–13** (decisão de 2026-07-04): o SaaS inteiro é construído e vendável sobre dados simulados; as plataformas plugam na mesma interface no final.
